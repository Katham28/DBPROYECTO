...
public class Facade_modificar {
	StrategyContext strategycontext= new StrategyContext();
	public Facade_modificar() {
		// TODO Auto-generated constructor stub
	}
	
	public int modficar(Prenda prenda, String categ, Connection connect) {
		...
		//else {
			...
			re=1;
			strategycontext.strategy_gestion_prendas.modificar_prenda(prenda, connect);
		//}
