...
public class Pantalla_Iniciar_Sesion extends Pantalla_secundaria{
	...
	public JButton getBoton_iniciarsesion() {
		return boton_iniciarsesion;
	}


	public void setBoton_iniciarsesion(JButton boton_iniciarsesion) {
	...
	public JButton getBoton_olvido() {
		return boton_olvido;
	}


	public void setBoton_olvido(JButton boton_olvido) {
		this.boton_olvido = boton_olvido;
	}
		...
		super(num_fondo, num_musica);
			...
			boton_iniciarsesion.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					}else if (textField.getText().length()>20 || passwordField.getText().length()>20) {
						lblNewLabel_2.setText("Sólo 20 carácteres máximos permitidos");
						lblNewLabel_2.setOpaque(true);
						lblNewLabel_2.setVisible(true);		
					}else if (passwordField.getText().length()<8) {
					lblNewLabel_2.setText("Contraseña mínimo 8 caracteres");
					lblNewLabel_2.setOpaque(true);
					lblNewLabel_2.setVisible(true);	
