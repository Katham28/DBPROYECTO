...
public class Pantalla_Mod_Eli_Admin extends JPanel {
	...
	JButton boton_ELI= 		new JButton("ELIMINAR");
	JButton boton_buscar = new JButton("BUSCAR");
	JButton boton_conf = new JButton("AJUSTES");
	JButton boton_MOD= new JButton("MODIFICAR");
	...
	public JButton getBoton_conf() {
		return boton_conf;
	}

	public void setBoton_conf(JButton boton_conf) {
		this.boton_conf = boton_conf;
	}
	...
	public JTextField getTextField_4B() {
		return textField_4B;
	}

	public void setTextField_4B(JTextField textField_4B) {
		this.textField_4B = textField_4B;
	}
	...
	public JButton getBoton_MOD() {
		return boton_MOD;
	}

	public void setBoton_MOD(JButton boton_MOD) {
		this.boton_MOD = boton_MOD;
	}

	public JButton getBoton_ELI() {
		return boton_ELI;
	}

	public void setBoton_ELI(JButton boton_ELI) {
		this.boton_ELI = boton_ELI;
	}
			...
			public void actionPerformed(ActionEvent e) {
	            ...
	            if (textField.getText().isBlank() ||
	                ...
	                return;
	            		...
	            		|| textField_3.getText().length()>20 
	            		|| textField_1.getText().length()>20 
	            		||  textField_2.getText().length()>20) {
					lblmensaje2.setText("Sólo 20 carácteres máximos permitidos");
					lblmensaje2.setOpaque(true);
					lblmensaje2.setVisible(true);
					return;
				}else {
