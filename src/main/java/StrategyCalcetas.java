...
public class StrategyCalcetas implements Strategy_gestion_prendas {

	

	public String tabla="Calcetas";
	@Override
	...
	public Categoria buscar_todos(Connection connect) {
	    Categoria categ = new Categoria(tabla, 0);
