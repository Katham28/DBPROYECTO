...
public class Pantalla_Menu_principal extends Pantalla_secundaria {
	...
	public JButton getBotton_items() {
		return botton_items;
	}

	public void setBotton_items(JButton botton_items) {
		this.botton_items = botton_items;
	}

	public JButton getBoton_crear_cuenta() {
		return boton_crear_cuenta;
	}

	public void setBoton_crear_cuenta(JButton boton_crear_cuenta) {
	...
	public Pantalla_Menu_principal(int num_fondo, int num_musica) {
		...
		boton_reporte_all.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				//report.reporte_prendas_usuario("birdi");
			}
		});
		boton_reporte_all.setBounds(10, 131, 124, 93);
