...
public class Pantalla_Recuperar_password extends Pantalla_secundaria{
	private JTextField textField_codigo = new JTextField("");
	private JTextField passwordField = new JTextField("");
	private JTextField 	passwordField_1 = new JTextField("");
	private JTextField textField_1= new JTextField("");;
	private JTextField textField_usuario = new JTextField("");
	private JLabel 		lblNewLabel_mensaje =new JLabel("");
	private JLabel	lblNewLabel_mensaje1 =new JLabel("");
	private JLabel 		lblNewLabel_mensaje2 =new JLabel("");
	...
	public void confeti (JButton boton) {
		this.mostrarConfeti(boton);
	}
	
	public JTextField getTextField_codigo() {
		return textField_codigo;
	}

	public void setTextField_codigo(JTextField textField_codigo) {
	...
	public JLabel getLblNewLabel_mensaje() {
		return lblNewLabel_mensaje;
	}


	public void setLblNewLabel_mensaje(JLabel lblNewLabel_mensaje) {
		this.lblNewLabel_mensaje = lblNewLabel_mensaje;
	}


	public JLabel getLblNewLabel_mensaje1() {
		return lblNewLabel_mensaje1;
	}

	public void setLblNewLabel_mensaje1(JLabel lblNewLabel_mensaje1) {
		this.lblNewLabel_mensaje1 = lblNewLabel_mensaje1;
	}


	public JLabel getLblNewLabel_mensaje2() {
		return lblNewLabel_mensaje2;
	}

	public void setLblNewLabel_mensaje2(JLabel lblNewLabel_mensaje2) {
		this.lblNewLabel_mensaje2 = lblNewLabel_mensaje2;
	}


	public JLabel getLblNewLabel3_codigo_obtenido() {
		return lblNewLabel3_codigo_obtenido;
	}

	public void setLblNewLabel3_codigo_obtenido(JLabel lblNewLabel3_codigo_obtenido) {
		this.lblNewLabel3_codigo_obtenido = lblNewLabel3_codigo_obtenido;
	}
	...
	public JButton getBoton_confirmar_codigo() {
		return boton_confirmar_codigo;
	}


	public void setBoton_confirmar_codigo(JButton boton_confirmar_codigo) {
		this.boton_confirmar_codigo = boton_confirmar_codigo;
	}

	public JButton getBoton_cambiar() {
		return boton_cambiar;
	}

	public void setBoton_cambiar(JButton boton_cambiar) {
		this.boton_cambiar = boton_cambiar;
	}

	public JButton getBoton_obtener_codigo() {
		return boton_obtener_codigo;
	}


	public void setBoton_obtener_codigo(JButton boton_obtener_codigo) {
		this.boton_obtener_codigo = boton_obtener_codigo;
	}
	...
	public Pantalla_Recuperar_password(int num_fondo, int num_musica) {
		...
		boton_obtener_codigo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				} else if (textField_usuario.getText().length()>20 ) {
					 lblNewLabel_mensaje1.setText("Sólo 20 carácteres máximos permitidos");
					 lblNewLabel_mensaje1.setOpaque(true);
					 lblNewLabel_mensaje1.setVisible(true);		
				}
				
				else {  //si esta lleno y con menos de 20 caracteres
		...
		boton_confirmar_codigo.addActionListener(new ActionListener() {
			...
			if (textField_codigo.getText().isEmpty() ) {
					 lblNewLabel_mensaje2.setText("Llena el campo requerido");
					 lblNewLabel_mensaje2.setOpaque(true);
					 lblNewLabel_mensaje2.setVisible(true);		
			}else if (textField_codigo.getText().length()>20 ) {
					 lblNewLabel_mensaje2.setText("Sólo 20 carácteres máximos permitidos");
					 lblNewLabel_mensaje2.setOpaque(true);
					 lblNewLabel_mensaje2.setVisible(true);		
			}else {
					Controlador_Correo controlador_correo= new Controlador_Correo ();
					...
					if(re==0) {
						...
						lblNewLabel_mensaje2.setVisible(true);
						confeti(boton_confirmar_codigo);
		...
		boton_cambiar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (passwordField.getText().isEmpty() || passwordField_1.getText().isEmpty()) {
					...
					lblNewLabel_mensaje.setVisible(true);
				}else if (textField_usuario.getText().length()>20 || passwordField.getText().length()>20 || textField_1.getText().length()>20 ||  passwordField_1.getText().length()>20) {
					lblNewLabel_mensaje.setText("Sólo 20 carácteres máximos permitidos");
					lblNewLabel_mensaje.setOpaque(true);
					lblNewLabel_mensaje.setVisible(true);		
				}else if (passwordField.getText().length()<8 ||  passwordField_1.getText().length()<8) {
					lblNewLabel_mensaje.setText("Contraseña mínimo 8 caracteres");
					lblNewLabel_mensaje.setOpaque(true);
					lblNewLabel_mensaje.setVisible(true);	
				} else {
					Controlador_Usuario basesita= new Controlador_Usuario ();
